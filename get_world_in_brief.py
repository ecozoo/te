...
def web_process(**kwargs):
    ...
    mdlines = []
    # mdlines.append('> **Read all homepage articles of The Economist without leaving GitHub.** [Try it now >>](https://arielherself.github.io/te)')
    ...
    """
    mdlines_proxied.append('|<br><div align="center"><img src="unlock.png" /><h1>Privacy Information</h1></div></br>We use a certain script to prevent the paywall from loading, thus links contained lead you to proxied corresponding webpages. \
...
<br><br>[&#x21BA; Visit the unmodified version](README.raw.md)<br><br>|\n|-----|')
    """
...
if __name__ == '__main__':
    ...
    with open('the-world-in-brief.md', 'w', encoding='utf8') as fil:
        print(*page_proxied, sep='\n\n', file=fil)
    # with open('README.raw.md', 'w', encoding='utf8') as fil:
    with open('the-world-in-brief.raw.md', 'w', encoding='utf8') as fil:
        print(*page_raw, sep='\n\n', file=fil)
